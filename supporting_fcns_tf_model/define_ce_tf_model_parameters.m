...
ce_tf_subsys_params = rmfield(params_temp,params_to_remove);

ce_tf_subsys_params.A = params_temp.overall_surface_area_for_given_layers; % This shorter name is consistent with equations in publications and is easier to parse by eyes when written in code
...
ce_tf_subsys_params.De_eff_sep = electrolyteDiffusionCoefficients(params_temp.ce_init,params_temp.Tref,params_temp,'s');
ce_tf_subsys_params.De_eff_neg = electrolyteDiffusionCoefficients(params_temp.ce_init,params_temp.Tref,params_temp,'n');
