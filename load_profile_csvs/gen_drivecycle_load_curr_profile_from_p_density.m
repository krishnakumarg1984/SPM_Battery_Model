...
V_median = 3.6;
C_rate_udds = P_cell_udds*3/max(P_cell_udds);  % hard-coding a lot of values!!
plot(C_rate_udds);
t = (linspace(0,length(C_rate_udds)-1,length(C_rate_udds)))';
csvwrite('udds_soc_50.csv',[t C_rate_udds],2,0)
return;
%% 
cycle_name = 'eudc';
