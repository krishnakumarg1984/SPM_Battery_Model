...
% axes(ha(2));
subplot(222);
plot(time_vector_p2d,ce_pos_p2d_newconvention(:,end),'color',cbrewerdarkgray); 
hold on;
...
% axes(ha(3));
subplot(223);
plot(t_common,abs(ce_neg_p2d_newconvention(1:length(t_common),1) - ce_neg_cc_quadratic(1:length(t_common))'),'color','k');
...
hold on;
plot(t_common,abs(ce_neg_p2d_newconvention(1:length(t_common),1) - ce_neg_cc_tf(1:length(t_common))'),'color',cbrewer_Gnbubu_blue);
...
% axes(ha(4));
subplot(224);
plot(t_common,abs(ce_pos_p2d_newconvention(1:length(t_common),end) - ce_pos_cc_quadratic(1:length(t_common))'),'color','k'); 
hold on;
plot(t_common,abs(ce_pos_p2d_newconvention(1:length(t_common),end) - ce_pos_cc_tf(1:length(t_common))'),'color',cbrewer_Gnbubu_blue); 
hold off;
ylabel('$\mathrm{mol\, m}^{-3}$');
...
% custom_m2t_fcn('tf_quad_ce_at_cc_1Cdischg',[figW_cm,figH_cm]*10,[],false,extra_axis_options);
% close;
